...
public class FixIndexFileCorruptDto {

    @NotEmpty(message = "{FixIndexFileCorruptDto.selectedAnsibleGroup}")
    String ansibleGroup;
    
    @NotEmpty(message = "{FixIndexFileCorruptDto.selectedAnsibleHost}")
    String ansibleHost;
